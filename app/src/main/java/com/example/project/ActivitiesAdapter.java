...
public class ActivitiesAdapter extends BaseAdapter {
    ...
    public ActivitiesAdapter(Context context, Map<Long, Activity> activityList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.finished.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                itemState.put(activity.getActivityId(), isChecked); //we do not have ID before db set up
            }
        });
        ...
        String userFullName = db.getUsersFullNameFromId(activity.getUserId());
        String usernameText = userFullName + " (ID: " + activity.getUserId() + ")";
        holder.username.setText(usernameText);
        //if(itemState.get(activity.getActivityId()) != null)
